...
const is31fl3733_led_t PROGMEM g_is31fl3733_leds[IS31FL3733_LED_COUNT] = {
    //Main RGB
    {0, SW4_CS1,    SW5_CS1,    SW6_CS1},       // "ESC`"
    {0, SW4_CS2,    SW5_CS2,    SW6_CS2},       // "!1"
    {0, SW4_CS3,    SW5_CS3,    SW6_CS3},       // "@2"
    {0, SW4_CS4,    SW5_CS4,    SW6_CS4},       // "#3"
    {0, SW1_CS6,    SW2_CS6,    SW3_CS6},       // "4"
    {0, SW1_CS7,    SW2_CS7,    SW3_CS7},       // "5"
    {0, SW1_CS8,    SW2_CS8,    SW3_CS8},       // "6"
    {0, SW1_CS9,    SW2_CS9,    SW3_CS9},       // "7"
    {0, SW1_CS10,   SW2_CS10,   SW3_CS10},      // "8"
    {1, SW1_CS1,    SW2_CS1,    SW3_CS1},       // "(9"
    {1, SW1_CS2,    SW2_CS2,    SW3_CS2},       // ")0"
    {1, SW1_CS3,    SW2_CS3,    SW3_CS3},       // "_-"
    {1, SW1_CS4,    SW2_CS4,    SW3_CS4},       // "+="
    {1, SW1_CS5,    SW2_CS5,    SW3_CS5},       // "Backsp"
    {1, SW1_CS6,    SW2_CS6,    SW3_CS6},       // "ins"

    {0, SW4_CS5,    SW5_CS5,    SW6_CS5},       // "Tab"
    {0, SW4_CS6,    SW5_CS6,    SW6_CS6},       // "Q"
    {0, SW4_CS7,    SW5_CS7,    SW6_CS7},       // "W"
    {0, SW4_CS8,    SW5_CS8,    SW6_CS8},       // "E"
    {0, SW4_CS9,    SW5_CS9,    SW6_CS9},       // "R"
    {0, SW4_CS10,   SW5_CS10,   SW6_CS10},      // "T"
    {1, SW4_CS1,    SW5_CS1,    SW6_CS1},       // "Y"
    {1, SW4_CS2,    SW5_CS2,    SW6_CS2},       // "U"
    {1, SW4_CS3,    SW5_CS3,    SW6_CS3},       // "I"
    {1, SW4_CS4,    SW5_CS4,    SW6_CS4},       // "O"
    {1, SW4_CS5,    SW5_CS5,    SW6_CS5},       // "P"
    {1, SW1_CS7,    SW2_CS7,    SW3_CS7},       // "{["
    {1, SW1_CS8,    SW2_CS8,    SW3_CS8},       // "}]"
    {1, SW1_CS9,    SW2_CS9,    SW3_CS9},       // "|\\"
    {1, SW1_CS10,   SW2_CS10,   SW3_CS10},      // "del"
    ...
    {1, SW7_CS1,    SW8_CS1,    SW9_CS1},       // "K"
    {1, SW7_CS2,    SW8_CS2,    SW9_CS2},       // "L"
    {1, SW7_CS3,    SW8_CS3,    SW9_CS3},       // ":"
    {1, SW7_CS4,    SW8_CS4,    SW9_CS4},       // "\""
    {1, SW7_CS5,    SW8_CS5,    SW9_CS5},       // "Enter"
    {1, SW7_CS10,   SW8_CS10,   SW9_CS10},      // "PGUP"
    ...
    {1, SW4_CS8,    SW5_CS8,    SW6_CS8},       // "Shift"
    {1, SW4_CS9,    SW5_CS9,    SW6_CS9},       // "UP"
    {1, SW4_CS10,   SW5_CS10,   SW6_CS10},      // "PGDN"

    {0, SW7_CS9,    SW8_CS9,    SW9_CS9},       // "Ctrl"
    {0, SW7_CS10,   SW8_CS10,   SW9_CS10},      // "Opt"
    {0, SW10_CS2,    SW11_CS2,    SW12_CS2},       // "Cmd"
    {1, SW10_CS3,    SW11_CS3,    SW12_CS3},       // "Space"
    {1, SW10_CS4,    SW11_CS4,    SW12_CS4},       // "Cmd"
    {1, SW10_CS5,    SW11_CS5,    SW12_CS5},       // "Fn"
    {1, SW7_CS7,    SW8_CS7,    SW9_CS7},       // "LEFT"
    {1, SW7_CS8,    SW8_CS8,    SW9_CS8},       // "DOWN"
    {1, SW7_CS9,    SW8_CS9,    SW9_CS9},       // "RIGHT"
