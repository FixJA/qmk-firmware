...
// layer 1 Mac Fn
[1] = LAYOUT(
    KC_GRV,     KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,     MAC_PRT,                TOG_POWER_ON_ANIMATION,
    _______,    LNK_BLE1,   LNK_BLE2,   LNK_BLE3,   LNK_RF,     _______,    DEBOUNCE_PRESS_DEC,     DEBOUNCE_PRESS_SHOW,    DEBOUNCE_PRESS_INC,     TOG_DEEP_SLEEP, TOG_USB_SLP, DEV_RESET, SLEEP_MODE, BAT_SHOW, _______ ,
...
[2] = LAYOUT(
    ...
    KC_LSFT,                KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,                KC_UP,      KC_PGDN,
    KC_LCTL,    KC_LWIN,    KC_LALT,                                        LT(5, KC_SPC),                                  KC_RALT,    MO(3),                    KC_LEFT,    KC_DOWN,    KC_RIGHT),

// layer 3 Windows Fn
[3] = LAYOUT(
    KC_GRV,     KC_BRID,    KC_BRIU,    _______,    _______,    _______,    KC_MPRV,    KC_MPLY,    KC_MNXT,    KC_MUTE,    KC_VOLD,    KC_VOLU,    KC_PSCR,    TOG_POWER_ON_ANIMATION, _______ ,
    _______,    LNK_BLE1,   LNK_BLE2,   LNK_BLE3,   LNK_RF,     _______,    DEBOUNCE_PRESS_DEC,     DEBOUNCE_PRESS_SHOW,    DEBOUNCE_PRESS_INC,     TOG_DEEP_SLEEP, TOG_USB_SLP, DEV_RESET, SLEEP_MODE, BAT_SHOW, _______ ,
    TOG_CAPS_IND, SLEEP_TIMEOUT_DEC, SLEEP_TIMEOUT_SHOW, SLEEP_TIMEOUT_INC, _______,    _______,    DEBOUNCE_RELEASE_DEC,   DEBOUNCE_RELEASE_SHOW,  DEBOUNCE_RELEASE_INC,   _______,    _______,    _______,    _______,                            _______,
    _______,                _______,    _______,    RGB_TEST,   _______,    _______,    _______,    MO(4),      RM_SPDD,    RM_SPDU,    _______,    _______,                RM_VALU,    _______,
    _______,    _______,    _______,                                        _______,                                        _______,    MO(3),                    RM_NEXT,     RM_VALD,     RM_HUEU),

// layer 4 side lighting
[4] = LAYOUT(
