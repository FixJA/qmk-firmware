...
[1] = LAYOUT(
	...
	MO(5),				    _______,   	_______,   	_______,  	_______,    _______,   	_______,	MO(4), 		RM_SPDD,	RM_SPDU,	_______,	MO(5),	                RM_VALU,    KC_END,
...
[3] = LAYOUT(
	...
	_______, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,    	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	DEV_RESET,	SLEEP_MODE, BAT_SHOW,	            _______,
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,	_______,   	_______,   	_______,  	_______,	_______, 	_______,                            KC_HOME,
	MO(6),				    _______,   	_______,   	_______,  	_______,    _______,   	_______,	MO(4), 		RM_SPDD,	RM_SPDU,	_______,	MO(6),	                RM_VALU,    KC_END,
